...
if(command!=='pack'||!input||!output) {
  ...
  fs.writeFileSync(target,JSON.stringify({format:'schuetzen-system-backup',version:privacy?2:1,manifest,database:database.toString('base64'),privacy_journal:privacy}),{flag:'wx',flush:true,mode:0o600});
